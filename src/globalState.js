...
const GlobalStateProvider = ({ children }) => {
  ...
  return (
    <GlobalStateContest.Provider
      value={{ showAlert, setShowAlert, data, setData, knightAdded, setKnightAdded, blockCells, setBlockCells, position, setPosition }}
    >
      {children}
    </GlobalStateContest.Provider>
  );
...
export { GlobalStateContest, GlobalStateProvider, emptyData, emptyAlert, emptyPosition };
